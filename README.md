...
1. Lists are compiled between each pair of adjacent layers, consisting of the edges groups orders that each neuron forms.
2. The list of edges groups orders is compiled for each edge group order that it generates.
