...
When constructing each layer in the network of this type, the edges traversed in all previous layers are not used. This allows us to significantly speed up the checking of graphs for isomorphism and finding graph orbits.
